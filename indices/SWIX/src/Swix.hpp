...
template<class Type_Key, class Type_Ts, size_t TimeWindow = TIME_WINDOW>
class SWmeta
{
private:
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
SWmeta<Type_Key,Type_Ts,TimeWindow>::SWmeta(pair<Type_Key, Type_Ts> & arrivalTuple)
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
SWmeta<Type_Key,Type_Ts,TimeWindow>::SWmeta(const vector<pair<Type_Key, Type_Ts>> & stream)
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
SWmeta<Type_Key,Type_Ts,TimeWindow>::~SWmeta()
{
    if (m_ptr.size())
    {
        for (auto & it: m_ptr)
...
*/
template<class Type_Key, class Type_Ts, size_t TimeWindow>
void SWmeta<Type_Key,Type_Ts,TimeWindow>::bulk_load(const vector<pair<Type_Key, Type_Ts>> & stream)
{
    #ifdef DEBUG
...
*/
template<class Type_Key, class Type_Ts, size_t TimeWindow>
void SWmeta<Type_Key,Type_Ts,TimeWindow>::split_data_slope(vector<pair<Type_Key,Type_Ts>> & data, 
                                vector<pair<Type_Key, SWseg<Type_Key,Type_Ts> * >> & splitedDataPtr)
{  
    #ifdef DEBUG
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
void SWmeta<Type_Key,Type_Ts,TimeWindow>::retrain_seg(pair<int,int> SWsegIndexes, Type_Ts & lowerLimit,
                                vector<pair<Type_Key, SWseg<Type_Key,Type_Ts> * >> & splitedDataPtr)
{  
    #ifdef DEBUG
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
void SWmeta<Type_Key,Type_Ts,TimeWindow>::lookup(pair<Type_Key, Type_Ts> & arrivalTuple, Type_Key & resultCount)
{
    #if defined DEBUG 
    ...
    // Type_Ts lowerLimit =  ((double)m_maxTs - static_cast<Type_Ts>(TimeWindow) < numeric_limits<Type_Ts>::min()) ? numeric_limits<Type_Ts>::min(): m_maxTs - static_cast<Type_Ts>(TimeWindow);
    Type_Ts lowerLimit =  ((double)newTimeStamp - static_cast<Type_Ts>(TimeWindow) < numeric_limits<Type_Ts>::min()) ? numeric_limits<Type_Ts>::min(): newTimeStamp - static_cast<Type_Ts>(TimeWindow);
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
void SWmeta<Type_Key,Type_Ts,TimeWindow>::range_search(tuple<Type_Key, Type_Ts, Type_Key> & arrivalTuple,
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
void SWmeta<Type_Key,Type_Ts,TimeWindow>::range_search_ordered_data(tuple<Type_Key, Type_Ts, Type_Key> & arrivalTuple,
                                                vector<pair<Type_Key, Type_Ts>> & rangeSearchResult)
{    
    // Type_Ts lowerLimit =  ((double)m_maxTs - static_cast<Type_Ts>(TimeWindow) < numeric_limits<Type_Ts>::min()) ? numeric_limits<Type_Ts>::min(): m_maxTs - static_cast<Type_Ts>(TimeWindow);
    Type_Ts lowerLimit =  ((double)get<1>(arrivalTuple) - static_cast<Type_Ts>(TimeWindow) < numeric_limits<Type_Ts>::min()) 
                            ? numeric_limits<Type_Ts>::min(): get<1>(arrivalTuple) - static_cast<Type_Ts>(TimeWindow);
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
void SWmeta<Type_Key,Type_Ts,TimeWindow>::insert(pair<Type_Key, Type_Ts> & arrivalTuple)
{
    #if defined DEBUG 
...
*/
template<class Type_Key, class Type_Ts, size_t TimeWindow>
void SWmeta<Type_Key,Type_Ts,TimeWindow>::meta_insertion(pair<Type_Key, SWseg<Type_Key,Type_Ts>*> & insertKeyPtr, int & retrainExtendFlag, bool retrainSetBit)
{
    #if defined(TUNE_TIME) || defined(TIME_BREAKDOWN)
    #ifdef TUNE_TIME
    rootNoInsert++;
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
void SWmeta<Type_Key,Type_Ts,TimeWindow>::meta_insertion_model(int & insertionPos, pair<Type_Key, SWseg<Type_Key,Type_Ts>*> & insertKeyPtr, bool & gapAddError, int & retrainExtendFlag, bool & retrainSetBit)
{
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
void SWmeta<Type_Key,Type_Ts,TimeWindow>::meta_insertion_end(pair<Type_Key, SWseg<Type_Key,Type_Ts>*> & insertKeyPtr, int & retrainExtendFlag, bool & retrainSetBit)
{
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
void SWmeta<Type_Key,Type_Ts,TimeWindow>::meta_insertion_append(int & insertionPos, pair<Type_Key, SWseg<Type_Key,Type_Ts>*> & insertKeyPtr, int & retrainExtendFlag, bool & retrainSetBit)
{
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
void SWmeta<Type_Key,Type_Ts,TimeWindow>::meta_extend_retrain(int & retrainExtendFlag, Type_Ts & lowerLimit)
{
    #ifdef TUNE_TIME
    rootNoRetrain++;
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
void SWmeta<Type_Key,Type_Ts,TimeWindow>::predict_search(Type_Key & targetKey, int & foundPos)
{
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline void SWmeta<Type_Key,Type_Ts,TimeWindow>::find_predict_pos_bound(Type_Key & targetKey, int & predictPos, int & predictPosMin, int & predictPosMax)
{
    #ifdef TUNE_TIME
    uint64_t temp = 0;
    startTimer(&temp);
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline void SWmeta<Type_Key,Type_Ts,TimeWindow>::exponential_search(Type_Key & targetKey, int & foundPos)
{
    #ifdef TUNE_TIME
    uint64_t temp = 0;
    startTimer(&temp);
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline void SWmeta<Type_Key,Type_Ts,TimeWindow>::exponential_search_insert(Type_Key & targetKey, int & foundPos)
{
    #ifdef TUNE_TIME
    uint64_t temp = 0;
    startTimer(&temp);
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline void SWmeta<Type_Key,Type_Ts,TimeWindow>::exponential_search_right(Type_Key & targetKey, int & foundPos, int maxSearchBound)
{
    #ifdef TUNE
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline void SWmeta<Type_Key,Type_Ts,TimeWindow>::exponential_search_right_insert(Type_Key & targetKey, int & foundPos, int maxSearchBound)
{
    #ifdef TUNE
    int predictPos = foundPos;
    #endif
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline void SWmeta<Type_Key,Type_Ts,TimeWindow>::exponential_search_left(Type_Key & targetKey, int & foundPos, int maxSearchBound)
{
    #ifdef TUNE
    int predictPos = foundPos;
    #endif
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline void SWmeta<Type_Key,Type_Ts,TimeWindow>::exponential_search_left_insert(Type_Key & targetKey, int & foundPos, int maxSearchBound)
{
    #ifdef TUNE
    int predictPos = foundPos;
    #endif
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
size_t SWmeta<Type_Key,Type_Ts,TimeWindow>::get_meta_size()
{
    return m_keys.size();
}

template<class Type_Key, class Type_Ts, size_t TimeWindow>
size_t SWmeta<Type_Key,Type_Ts,TimeWindow>::get_no_seg()
{
    return m_numPairExist;
}

template<class Type_Key, class Type_Ts, size_t TimeWindow>
int SWmeta<Type_Key,Type_Ts,TimeWindow>::get_split_error()
{
    return splitError;
}

template<class Type_Key, class Type_Ts, size_t TimeWindow>
void SWmeta<Type_Key,Type_Ts,TimeWindow>::set_split_error(int error)
{
    splitError = error;
}

template<class Type_Key, class Type_Ts, size_t TimeWindow>
void  SWmeta<Type_Key,Type_Ts,TimeWindow>::print()
{
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
void  SWmeta<Type_Key,Type_Ts,TimeWindow>::print_all()
{
    for (int i = 0; i < m_keys.size(); i++)
    {
        if (bitmap_exists(i))
...
template <class Type_Key, class Type_Ts, size_t TimeWindow>
inline uint64_t SWmeta<Type_Key,Type_Ts,TimeWindow>::get_total_size_in_bytes()
{
    uint64_t leafSize = 0;
    for (int i = 0; i < m_keys.size(); i++)
    {
...
template <class Type_Key, class Type_Ts, size_t TimeWindow>
inline uint64_t SWmeta<Type_Key,Type_Ts,TimeWindow>::get_no_keys(Type_Ts Timestamp)
{
    Type_Ts lowerLimit =  ((double)Timestamp - static_cast<Type_Ts>(TimeWindow) < numeric_limits<Type_Ts>::min()) ? numeric_limits<Type_Ts>::min(): Timestamp - static_cast<Type_Ts>(TimeWindow);
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
void SWmeta<Type_Key,Type_Ts,TimeWindow>::print_stats()
{   
    #ifdef PRINT && TUNE
    printf("##### ROOT STATS ##### \n");
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline bool SWmeta<Type_Key,Type_Ts,TimeWindow>::bitmap_exists(int index) const
{
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline bool SWmeta<Type_Key,Type_Ts,TimeWindow>::bitmap_exists(vector<uint64_t> & bitmap, int index) const
{
    int bitmapPos = index >> 6;
    int bitPos = index - (bitmapPos << 6);
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline void SWmeta<Type_Key,Type_Ts,TimeWindow>::bitmap_set_bit(int index)
{
    int bitmapPos = index >> 6;
    int bitPos = index - (bitmapPos << 6);
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline void SWmeta<Type_Key,Type_Ts,TimeWindow>::bitmap_set_bit(vector<uint64_t> & bitmap, int index)
{
    int bitmapPos = index >> 6;
    int bitPos = index - (bitmapPos << 6);
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline void SWmeta<Type_Key,Type_Ts,TimeWindow>::bitmap_erase_bit(int index)
{
    int bitmapPos = index >> 6;
    int bitPos = index - (bitmapPos << 6);
    m_bitmap[bitmapPos] &= ~(1ULL << bitPos);
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline void SWmeta<Type_Key,Type_Ts,TimeWindow>::bitmap_erase_bit(vector<uint64_t> & bitmap, int index)
{
    int bitmapPos = index >> 6;
    int bitPos = index - (bitmapPos << 6);
    bitmap[bitmapPos] &= ~(1ULL << bitPos);
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline int SWmeta<Type_Key,Type_Ts,TimeWindow>::bitmap_closest_right_nongap(int index)
{
    int bitmapPos = index >> 6;
    int bitPos = index - (bitmapPos << 6);
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline int SWmeta<Type_Key,Type_Ts,TimeWindow>::bitmap_closest_left_nongap(int index)
{
    int bitmapPos = index >> 6;
    int bitPos = index - (bitmapPos << 6);
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline int SWmeta<Type_Key,Type_Ts,TimeWindow>::bitmap_closest_gap(int index)
{
    int bitmapPos = index >> 6;
    int bitPos = index - (bitmapPos << 6);
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline pair<int,int> SWmeta<Type_Key,Type_Ts,TimeWindow>::bitmap_retrain_range(int index)
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline void SWmeta<Type_Key,Type_Ts,TimeWindow>::bitmap_move_bit_back(int startingIndex, int endingIndex) 
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline void SWmeta<Type_Key,Type_Ts,TimeWindow>::bitmap_move_bit_back(vector<uint64_t> & bitmap, int startingIndex, int endingIndex) 
//Inclusive: [startingIndex,endingIndex] and startingIndex < endingIndex
{
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline void SWmeta<Type_Key,Type_Ts,TimeWindow>::bitmap_move_bit_front(int startingIndex, int endingIndex) 
//Inclusive: [startingIndex,endingIndex] and startingIndex > endingIndex
{
    int bitmapPos = startingIndex >> 6;
    int bitPos = startingIndex - (bitmapPos << 6);
...
template<class Type_Key, class Type_Ts, size_t TimeWindow>
inline void SWmeta<Type_Key,Type_Ts,TimeWindow>::bitmap_move_bit_front(vector<uint64_t> & bitmap, int startingIndex, int endingIndex) 
//Inclusive: [startingIndex,endingIndex] and startingIndex > endingIndex
{
    int bitmapPos = startingIndex >> 6;
    int bitPos = startingIndex - (bitmapPos << 6);
