...
class AlexModelNode : public AlexNode<T, P> {
 public:
  ...
  using alloc_type = typename std::allocator_traits<Alloc>::template rebind_alloc<self_type>;
  using pointer_alloc_type = typename std::allocator_traits<Alloc>::template rebind_alloc<AlexNode<T, P>*>;
...
class AlexDataNode : public AlexNode<T, P> {
 public:
  ...
  using alloc_type = typename std::allocator_traits<Alloc>::template rebind_alloc<self_type>;
  using key_alloc_type = typename std::allocator_traits<Alloc>::template rebind_alloc<T>;
  using payload_alloc_type = typename std::allocator_traits<Alloc>::template rebind_alloc<P>;
  using value_alloc_type = typename std::allocator_traits<Alloc>::template rebind_alloc<V>;
  using bitmap_alloc_type = typename std::allocator_traits<Alloc>::template rebind_alloc<uint64_t>;
