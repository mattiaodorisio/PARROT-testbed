...
%% IMPORT-DATA chisquared_data ../results_after_submission_v1/benchmark_chisquared_uint32_20260531_144712.txt
%% IMPORT-DATA exponential_data ../results_after_submission_v1/benchmark_exponential_uint32_20260531_015521.txt
%% IMPORT-DATA mix_gauss_data ../results_after_submission_v1/benchmark_mix_gauss_uint32_20260531_073327.txt
%% IMPORT-DATA normal_data ../results_after_submission_v1/benchmark_normal_uint32_20260530_204127.txt
%% IMPORT-DATA uniform_data ../results_after_submission_v1/benchmark_uniform_uint32_20260528_095901.txt
%% IMPORT-DATA zipf_data ../results_after_submission_v1/benchmark_zipf_uint32_20260531_195859.txt
...
%% SQL DELETE FROM stats WHERE index_name NOT LIKE '%DeLI%';
...
% Filter out small initial key sizes
%% SQL DELETE FROM stats WHERE init_num_keys < 16048576;

%% SQL CREATE TABLE insert_delete_stats AS SELECT * FROM stats WHERE workload_type == 'INSERT_DELETE';

%% SQL DELETE FROM stats WHERE workload_type == 'INSERT_DELETE';
...
\section{DeLI Dynamic Insert-Delete}\label{sec:deliconfig}
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    %%       RHTOptimization
    %%     FROM stats
    %%     WHERE index_name = 'DeLI-Static-Payload'
    %%   )
    %% )
    %% WHERE row_in_bucket = 1
    %% ORDER BY RHTOptimization, x
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    %%       RHTOptimization
    %%     FROM stats
    %%     WHERE index_name = 'DeLI-Dynamic-Payload'
    %%   )
    %% )
    %% WHERE row_in_bucket = 1
    %% ORDER BY RHTOptimization, x
